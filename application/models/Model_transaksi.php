...
class Model_transaksi extends CI_Model {
	...
	function selesai_belanja($data){
		...
		$lats_id = $this->db->query("select transaksi_id from transaksi order by transaksi_id desc")->row_array();
		$this->db->query("update transaksi_detail set transaksi_id='".$lats_id['transaksi_id']."' where status='0'");
