...
<table class="table table-bordered">
	<tr>
		...
		<td><input type="text" class="form-control" name="nama_barang" value="<?php echo $record['nama_barang'] ?>" placeholder="nama barang"></td>
	</tr>
	<tr>
		<td>Kategori</td>
	...
	<tr>
		<td>Harga</td>
		<td><input type="text" name="harga" class="form-control" value="<?php echo $record['harga'] ?>" placeholder="harga"></td>
	</tr>
	<tr>
